...
$(document).ready(function(){
    $('.slider__inner').slick({
        ...
        autoplaySpeed: 2500,
        focusOnSelect: true,
        prevArrow:'<button type="button" class="slick-prev"><img alt="arrow" src="icons/arrow_left.svg"></button>',
        nextArrow:'<button type="button" class="slick-next"><img alt="arrow" src="icons/arrow_right.svg"></button>',
        responsive:[
            {
                breakpoint: 992,
                settings: {
